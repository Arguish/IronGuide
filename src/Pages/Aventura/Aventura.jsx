  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          ▶ Conocimientos, perspicacia u observación, tira + mente. Éxito Total:
          Lo consigues o evitas la amenaza. Ganas +1 a Impulso.
        </li>
      </ul>
      ...
      <p>
        Fallo: Fracasas o tu progreso se ve obstaculizado por un giro dramático
        de los acontecimientos. Paga el precio.
      </p>
      ...
      <h1>REUNIR INFORMACIÓN</h1>
      <p>
        Cuando inspeccionas un área, haces preguntas, realizas una investigación
        o sigues un rastro, tira + mente. Si estás en una comunidad o haces
        preguntas a alguien con quien compartes un vínculo, suma +1.
      </p>
      <p>
      ...
      <p>
        Éxito Parcial: La información complica tu búsqueda o introduce un nuevo
        peligro. Imagina que descubres (o Pregunta al Oráculo). Ganas +1 de
        impulso.
      </p>
      <p>
      ...
      <h1>CURAR</h1>
      <p>
        Cuando tratas una lesión o una dolencia, tira + mente. Si estás tratando
        tus propias heridas, tira + mente o + hierro, la que sea menor.
      </p>
      <p>
        Éxito Total: El tratamiento funciona. Si tu personaje o el personaje
        aliado que tratas está herido, puedes eliminar dicha condición. Después,
        tu personaje o el aliado gana +2 de salud.
      </p>
      <p>
      ...
      <h1>REABASTECERSE</h1>
      <p>
        Cuando cazas, recoges alimentos o buscas para encontrar algo útil, tira
        + mente.
      </p>
      <p>Éxito Total: Aumentas tus suministros. Ganas +2 suministros.</p>
      <p>
        Éxito Parcial: Ganas hasta +2 de suministros, pero pierdes -1 de impulso
      ...
      <ul>
        ...
        <li>
          ◆ Compartir: Pierdes -1 de suministros y tanto tú como tus compañeros
          ganáis +1 Salud.
        </li>
        <li>◆ Relajarte: Ganas +1 de entereza.</li>
        <li>◆ Concentrarte: Ganas +1 impulso.</li>
        <li>
          ◆ Prepararte: Al abandonar el campamento, obtén una bonificación de +1
      ...
      <p>
        Fallo: No lo tienes y la situación se vuelve todavía más peligrosa Paga
        el precio.
      </p>
      <h1>VIAJAR</h1>
      <p>
      ...
      lugar, imagina como es o Pregunta al Oráculo. A continuación, escoge una:
      <ul>
        <li> ◆ Haces un buen uso de tus recursos. Registra el progreso.</li>
        <li>
          ◆ Fuerzas la marcha: Registras el progreso y ganas +1 de impulso, pero
      ...
      <p>
        Fallo: O bien te has perdido sin remedio; o bien una vez allí se revela
        que no ha servido de nada llegar, o tu información sobre el destino no
        era correcta.
      </p>
      <p>

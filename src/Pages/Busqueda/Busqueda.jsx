  ...
  return (
    <div>
      ...
      <p>
        ...
        +corazón. Si haces ese juramento a una persona o comunidad con la que
        tienes vínculo, suma +1.
      </p>
      <p>
        <strong>Éxito Total:</strong> Estás entusiasmado. Está claro lo que
        debes hacer a continuación. Pregunta al Oráculo. Ganas +2 de impulso.
      </p>
      <p>
        <strong>Éxito Parcial:</strong> Aunque enfrentas el futuro con
        determinación, comienzas tu búsqueda con más preguntas que respuestas.
        Ganas +1 de impulso. Establece qué haces para poner tu búsqueda en
        marcha.
      </p>
      <p>
        <strong>Fallo:</strong> Has de enfrentar un obstáculo considerable antes
        de comenzar con tu búsqueda. Determina qué se interpone en tu camino o
        Pregunta al Oráculo, y escoge uno:
      </p>
      <ul>
        <li>
          Sigues adelante: Pierdes -2 de impulso. Haz lo que debas para superar
          el obstáculo.
        </li>
        <li>Renuncias: Rompe tu juramento.</li>
      </ul>
      <h1>ALCANZAR UN HITO</h1>
      <p>
        ...
        resolviendo un misterio, derrotando una amenaza seria, obteniendo apoyos
        vitales o adquiriendo un objeto crucial, registra el progreso.
      </p>
      <ul>
      ...
      <h1>CUMPLIR TU JURAMENTO (M. PROGRESO)</h1>
      <p>
        Cuando crees haber cumplido tu palabra dada en un juramento, tira dos
        dados de desafío y compáralos con tu progreso. Ignora el impulso.
      </p>
      <p>
        <strong>Éxito Total:</strong> tu misión ha sido completada. Marca:
      </p>
      <ul>
      ...
      <p>
        <strong>Éxito Parcial:</strong> hay más por hacer o te das cuenta de la
        verdad de tu misión. Visualiza lo que descubres (Pregunta al Oráculo si
        no estás seguro). Luego, marca la experiencia:
      </p>
      <ul>
      ...
      <p>
        Puedes Jurar por el hierro para arreglar las cosas. Si lo haces, añade
        +1.
      </p>
      <p>
        <strong>Fallo:</strong> tu misión no ha terminado. Visualiza lo que
        sucede (Pregunta al Oráculo si no estás seguro) y elige uno:
      </p>
      <ul>
        <li>
          Te comprometes de nuevo: Elimina todo el progreso menos uno y sube el
          rango de la misión (si no es épica).
        </li>
        <li>Te rindes: Rompe tu juramento.</li>
      </ul>
      <h1>ROMPER TU JURAMENTO</h1>
      <p>
        Cuando renuncies a tu misión, traiciones tu promesa o el objetivo sea
        inalcanzable, elimina el voto y Soporta el estrés. Sufres -entereza
      ...
      <p>
        Si el juramento fue hecho a una persona o comunidad con la que compartes
        un vínculo, Pon a prueba el vínculo en tu próximo encuentro.
      </p>
      <h1>MEJORAR</h1>
      <p>
        Cuando practicas tus habilidades, recibes adiestramiento, encuentras
        inspiración, ganas una recompensa u obtienes un compañero, puedes gastar
        3 puntos de experiencia para adquirir un nuevo recurso o 2 puntos para
        mejorar uno que ya tienes.
      </p>
      <h1>MARCAR TU FRACASO</h1>
      <p>
      ...
      <h1>APRENDE DE TUS FRACASOS (M. PROGRESO)</h1>
      <p>
        Cuando dediques tiempo a reflexionar sobre tus dificultades y pasos en
        falso, y tu registro de fallos sea +6 o más, tira tus dados de desafío y
        compáralos con tu progreso. Ignora el impulso.
      </p>
      <p>
        <strong>Éxito Total:</strong> Te comprometes a hacer un cambio
        dramático. Obtén 3 experiencia y borra todo el progreso. Elige uno:
      </p>
      <ul>
        <li>
          Ajusta el enfoque: descarta un solo activo y gana 2 experiencia por
          cada habilidad marcada.
        </li>
        <li>
          Haz un juramento: Jurar por el hierro y vuelve a lanzar los dados.
        </li>
      ...
      <p>
        <strong>Fallo:</strong> Has aprendido las lecciones equivocadas. Gana 1
        experiencia y borra todo el progreso. Luego, visualiza cómo te
        embarcaste en un camino nefasto.
      </p>
      <h1>AVANZAR UNA AMENAZA</h1>
      <p>
        Cuando cedas terreno a una amenaza por inacción, fallo o retraso, pasa a
        la tabla a continuación e imagina cómo se manifiesta el cambio en el
        mundo o Pregunta al Oráculo. Con dados iguales, este desarrollo también
        expone un aspecto sorprendente del plan o la naturaleza de la amenaza.
        Si marcas la última casilla de una amenaza, la amenaza logra su objetivo
        o se produce el resultado nefasto final. Debes romper tu juramento.
      </p>
      <h1>MANEJA UNA RAREZA</h1>
